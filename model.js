...
const seedAssetPath = file => `./assets/figma-seed-home/${file}`;

const seedHomeProfiles = {
  festival: {
    hero: {
      contentId: 'festival',
      image: seedAssetPath('hero-1.png'),
      duration: '2 天 1 夜',
      kicker: '热门推荐',
      tags: ['非遗', '名画'],
      title: '葛仙村 · 千灯入夜',
      desc: '推荐葛仙村首次文化探索者，入夜后体验最佳',
      spot: '葛仙村',
    },
    imageOffset: 0,
    discover: [
      { contentId: 'festival', type: '灯会', tone: 'festival', title: '千灯入夜', subtitle: '从一条灯街开始，生成你的文化行程', tags: ['灯会', '夜游', '可生成'], reason: '夜游首选', duration: '2天1夜' },
      { contentId: 'craft', type: '非遗', tone: 'craft', title: '手作与火光', subtitle: '把一门技艺变成可参与的体验', tags: ['非遗', '技艺', '可点亮'], reason: '技艺体验', duration: '90分钟' },
      { contentId: 'village', type: '古村', tone: 'village', title: '山水里的村落', subtitle: '慢走、停留、把空间读成故事', tags: ['古村', '漫游', '行程'], reason: '慢游路线', duration: '半日' },
      { contentId: 'painting', type: '名画', tone: 'painting', title: '上元灯彩图', subtitle: '一幅画，拆出五个体验入口', tags: ['名画', '可拆解', '探画'], reason: '古画入口', duration: '15分钟' },
      { contentId: 'market', type: '灯会', tone: 'festival', title: '灵宝夜市', subtitle: '灯下小食、摊位与市井烟火', tags: ['灯会', '市集', '夜游'], reason: '烟火市集', duration: '夜间' },
      { contentId: 'paper', type: '非遗', tone: 'craft', title: '纸上灯影', subtitle: '从剪纸纹样进入一场手作体验', tags: ['非遗', '剪纸', '手作'], reason: '亲手完成', duration: '60分钟' },
    ],
  },
  market: {
    hero: {
      contentId: 'market',
      image: seedAssetPath('hero-2.jpg'),
      duration: '夜间',
      kicker: '宋风市井',
      tags: ['灯会', '市集'],
      title: '开封 · 汴梁夜市',
      desc: '从虹桥、市集和瓦肆进入清明上河式夜游',
      spot: '开封',
    },
    imageOffset: 6,
    discover: [
      { contentId: 'market', type: '灯会', tone: 'festival', title: '汴梁夜市', subtitle: '灯下小食、摊位与市井烟火', tags: ['灯会', '市集', '夜游'], reason: '烟火市集', duration: '夜间' },
      { contentId: 'festival', type: '灯会', tone: 'festival', title: '虹桥灯影', subtitle: '桥市人流和水岸灯火形成第一眼记忆', tags: ['灯会', '夜游', '可生成'], reason: '夜游首选', duration: '半日' },
      { contentId: 'village', type: '古村', tone: 'village', title: '汴河慢行', subtitle: '沿水路拆解舟桥、码头和街巷关系', tags: ['古村', '漫游', '行程'], reason: '慢游路线', duration: '半日' },
      { contentId: 'craft', type: '非遗', tone: 'craft', title: '瓦肆百戏', subtitle: '把观看表演转成可参与的民俗体验', tags: ['非遗', '技艺', '可点亮'], reason: '技艺体验', duration: '90分钟' },
      { contentId: 'painting', type: '名画', tone: 'painting', title: '清明上河线索', subtitle: '从画中虹桥反推现实游线和市井角色', tags: ['名画', '可拆解', '探画'], reason: '古画入口', duration: '15分钟' },
      { contentId: 'paper', type: '非遗', tone: 'craft', title: '宋式小物', subtitle: '把招幌、灯笼和桥影做成可带走纪念', tags: ['非遗', '手作', '市集'], reason: '亲手完成', duration: '60分钟' },
    ],
  },
  village: {
    hero: {
      contentId: 'village',
      image: seedAssetPath('hero-3.jpg'),
      duration: '半日',
      kicker: '江南慢游',
      tags: ['古村', '名画'],
      title: '苏州 · 平江水巷',
      desc: '跟随姑苏繁华图的水街、桥巷和小铺慢慢游',
      spot: '苏州',
    },
    imageOffset: 10,
    discover: [
      { contentId: 'village', type: '古村', tone: 'village', title: '平江水巷', subtitle: '慢走、停留、把空间读成故事', tags: ['古村', '漫游', '行程'], reason: '慢游路线', duration: '半日' },
      { contentId: 'market', type: '灯会', tone: 'festival', title: '桥边小市', subtitle: '店铺招幌和水岸人流构成江南烟火', tags: ['灯会', '市集', '夜游'], reason: '烟火市集', duration: '夜间' },
      { contentId: 'painting', type: '名画', tone: 'painting', title: '姑苏繁华线索', subtitle: '从长卷里提取园林、桥巷和商业记忆', tags: ['名画', '可拆解', '探画'], reason: '古画入口', duration: '15分钟' },
      { contentId: 'craft', type: '非遗', tone: 'craft', title: '评弹小坐', subtitle: '把声音、茶席和街巷停留组合成轻体验', tags: ['非遗', '技艺', '可点亮'], reason: '技艺体验', duration: '90分钟' },
      { contentId: 'paper', type: '非遗', tone: 'craft', title: '水乡纸灯', subtitle: '用桥影和窗格纹样完成一件轻手作', tags: ['非遗', '剪纸', '手作'], reason: '亲手完成', duration: '60分钟' },
      { contentId: 'festival', type: '灯会', tone: 'festival', title: '夜泊灯河', subtitle: '入夜后把水巷、灯影和小吃串成路线', tags: ['灯会', '夜游', '可生成'], reason: '夜游首选', duration: '2天1夜' },
    ],
  },
  craft: {
    hero: {
      contentId: 'craft',
      image: seedAssetPath('hero-4.jpg'),
      duration: '90 分钟',
      kicker: '海丝手作',
      tags: ['非遗', '技艺'],
      title: '泉州 · 非遗工坊',
      desc: '从提线木偶、南音和香铺进入可参与的工艺体验',
      spot: '泉州',
    },
    imageOffset: 2,
    discover: [
      { contentId: 'craft', type: '非遗', tone: 'craft', title: '木偶戏台', subtitle: '把一门技艺变成可参与的体验', tags: ['非遗', '技艺', '可点亮'], reason: '技艺体验', duration: '90分钟' },
      { contentId: 'paper', type: '非遗', tone: 'craft', title: '海丝香铺', subtitle: '用气味和纹样完成随身文化小物', tags: ['非遗', '手作', '市集'], reason: '亲手完成', duration: '60分钟' },
      { contentId: 'village', type: '古村', tone: 'village', title: '古厝慢游', subtitle: '在红砖、骑楼和巷口里观察城市记忆', tags: ['古村', '漫游', '行程'], reason: '慢游路线', duration: '半日' },
      { contentId: 'market', type: '灯会', tone: 'festival', title: '番仔楼夜市', subtitle: '用摊位和灯火承接海丝烟火气', tags: ['灯会', '市集', '夜游'], reason: '烟火市集', duration: '夜间' },
      { contentId: 'painting', type: '名画', tone: 'painting', title: '海贸图像线索', subtitle: '从器物、角色和街市提取古画解码灵感', tags: ['名画', '可拆解', '探画'], reason: '古画入口', duration: '15分钟' },
      { contentId: 'festival', type: '灯会', tone: 'festival', title: '刺桐灯会', subtitle: '夜游、表演和祈福组合成节庆路径', tags: ['灯会', '夜游', '可生成'], reason: '夜游首选', duration: '2天1夜' },
    ],
  },
  paper: {
    hero: {
      contentId: 'paper',
      image: seedAssetPath('hero-5.jpg'),
      duration: '60 分钟',
      kicker: '水乡灯影',
      tags: ['非遗', '古村'],
      title: '乌镇 · 纸灯小铺',
      desc: '在水巷和灯影里完成剪纸、拓印和小物体验',
      spot: '乌镇',
    },
    imageOffset: 8,
    discover: [
      { contentId: 'paper', type: '非遗', tone: 'craft', title: '纸灯小铺', subtitle: '从剪纸纹样进入一场手作体验', tags: ['非遗', '剪纸', '手作'], reason: '亲手完成', duration: '60分钟' },
      { contentId: 'village', type: '古村', tone: 'village', title: '乌篷慢游', subtitle: '沿水路停留，把桥、船和街巷读成故事', tags: ['古村', '漫游', '行程'], reason: '慢游路线', duration: '半日' },
      { contentId: 'festival', type: '灯会', tone: 'festival', title: '水岸灯会', subtitle: '灯火倒影和夜间小食形成轻路线', tags: ['灯会', '夜游', '可生成'], reason: '夜游首选', duration: '2天1夜' },
      { contentId: 'craft', type: '非遗', tone: 'craft', title: '蓝印花布', subtitle: '把传统纹样转成可带走的布艺小物', tags: ['非遗', '技艺', '可点亮'], reason: '技艺体验', duration: '90分钟' },
      { contentId: 'market', type: '灯会', tone: 'festival', title: '桥头茶点', subtitle: '茶铺、甜点和水边座位组成烟火停留', tags: ['灯会', '市集', '夜游'], reason: '烟火市集', duration: '夜间' },
      { contentId: 'painting', type: '名画', tone: 'painting', title: '灯影纹样库', subtitle: '从画中纹样提取纸灯和窗格灵感', tags: ['名画', '可拆解', '探画'], reason: '古画入口', duration: '15分钟' },
    ],
  },
  painting: {
    hero: {
      contentId: 'painting',
      image: seedAssetPath('hero-6.jpg'),
      duration: '15 分钟',
      kicker: '线上解码',
      tags: ['名画', '生成'],
      title: '线上 · 古画解码',
      desc: '从清明上河、姑苏繁华和上元灯彩里拆出体验入口',
      spot: '古画',
    },
    imageOffset: 4,
    discover: [
      { contentId: 'painting', type: '名画', tone: 'painting', title: '古画解码', subtitle: '一幅画，拆出五个体验入口', tags: ['名画', '可拆解', '探画'], reason: '古画入口', duration: '15分钟' },
      { contentId: 'market', type: '灯会', tone: 'festival', title: '清明上河市集', subtitle: '从虹桥、人流和摊贩里生成现实路线', tags: ['灯会', '市集', '夜游'], reason: '烟火市集', duration: '夜间' },
      { contentId: 'village', type: '古村', tone: 'village', title: '姑苏水巷慢游', subtitle: '从水街、桥巷和小铺里提取慢游线索', tags: ['古村', '漫游', '行程'], reason: '慢游路线', duration: '半日' },
      { contentId: 'festival', type: '灯会', tone: 'festival', title: '上元灯彩路线', subtitle: '把鳌山灯、街市和祈福转成夜游体验', tags: ['灯会', '夜游', '可生成'], reason: '夜游首选', duration: '2天1夜' },
      { contentId: 'craft', type: '非遗', tone: 'craft', title: '画中技艺线索', subtitle: '从器物和角色动作里找到可参与技艺', tags: ['非遗', '技艺', '可点亮'], reason: '技艺体验', duration: '90分钟' },
      { contentId: 'paper', type: '非遗', tone: 'craft', title: '纹样轻手作', subtitle: '把画中纹样拆成纸灯、拓印和印章', tags: ['非遗', '剪纸', '手作'], reason: '亲手完成', duration: '60分钟' },
    ],
  },
};

const seedDiscoverImages = [
  'img-01.jpg',
  'img-02.png',
  'img-03.jpg',
  'img-04.jpg',
...
const paintingRelatedImageOrder = [1, 5, 9, 3, 11, 2, 7, 12, 4, 8, 10, 6];
const paintingRelatedImageOffsets = [0, 6, 10];

export function getPaintingRelatedImage(paintingIndex = 0, cardIndex = 0) {
  const normalizedPaintingIndex = Math.abs(Number(paintingIndex) || 0);
  const normalizedCardIndex = Math.abs(Number(cardIndex) || 0);
  const offset = paintingRelatedImageOffsets[normalizedPaintingIndex % paintingRelatedImageOffsets.length];
  const imageIndex = (offset + normalizedCardIndex) % paintingRelatedImageOrder.length;
  return `./assets/figma-painting-tab/${paintingRelatedImageOrder[imageIndex]}.jpg`;
}
...
const experienceDestinationProfiles = {
  market: {
    modes: {
      night: {
        title: '汴梁夜市后的宋风文化体验单',
        desc: '跟随开封当前地址，优先推荐虹桥夜游、市集小食与宋风手作。',
        bestTime: '18:40',
        tag: '今日可体验',
      },
      craft: {
        title: '把宋风市井做成随身小物',
        desc: '优先推荐拓印、灯笼与招幌纹样，适合把夜市记忆带走。',
        bestTime: '16:50',
        tag: '工坊可约',
      },
      family: {
        title: '轻松参与的汴梁亲子路线',
        desc: '减少长距离移动，保留桥市观察、小食体验和轻手作。',
        bestTime: '15:40',
        tag: '轻松路线',
      },
    },
    routes: {
      night: [
        { time: '16:40', title: '入市取景', desc: '先在城门和水岸完成轻量取景，建立宋风市井氛围。' },
        { time: '18:40', title: '虹桥夜游', desc: '跟随桥市灯火进入夜游主线，观察摊位、人流和水路。' },
        { time: '19:30', title: '宋风手作', desc: '选择拓印或小灯笼，把清明上河线索转成参与动作。' },
        { time: '20:40', title: '夜市收束', desc: '用小食、合影和纪念物完成个人文化沉淀。' },
      ],
    },
  },
  village: {
    modes: {
      night: {
        title: '平江水巷里的江南慢游体验单',
        desc: '跟随苏州当前地址，优先推荐水巷慢游、桥边小市与纸灯手作。',
        bestTime: '17:30',
        tag: '今日可体验',
      },
      craft: {
        title: '把江南纹样做成自己的作品',
        desc: '优先推荐纸灯、窗格纹样和评弹小坐，适合安静文艺偏好。',
        bestTime: '16:20',
        tag: '工坊可约',
      },
      family: {
        title: '低强度的水巷亲子文化体验',
        desc: '保留桥巷观察、轻手作和水边停留，降低步行压力。',
        bestTime: '15:20',
        tag: '轻松路线',
      },
    },
    routes: {
      night: [
        { time: '16:20', title: '水巷入场', desc: '从主街进入平江水巷，先完成水岸、桥洞和街铺观察。' },
        { time: '17:30', title: '桥巷慢游', desc: '沿桥巷停留，提取姑苏繁华图里的水街、店铺和人流线索。' },
        { time: '18:20', title: '纸灯手作', desc: '用窗格和桥影纹样完成一件可带走的小纸灯。' },
        { time: '19:10', title: '水边收束', desc: '在水岸茶点或评弹小坐中完成安静沉淀。' },
      ],
    },
  },
  craft: {
    modes: {
      night: {
        title: '泉州古城里的海丝文化体验单',
        desc: '跟随泉州当前地址，优先推荐古厝慢游、木偶戏台与海丝手作。',
        bestTime: '17:10',
        tag: '今日可体验',
      },
    },
    routes: {
      night: [
        { time: '16:10', title: '古厝入场', desc: '从红砖古厝进入，观察骑楼、巷口和海丝器物线索。' },
        { time: '17:10', title: '木偶戏台', desc: '观看提线木偶片段，理解角色动作和民俗技艺。' },
        { time: '18:00', title: '海丝手作', desc: '选择香牌或纹样拓印，把城市记忆转成随身小物。' },
        { time: '19:00', title: '番仔楼夜游', desc: '用夜市和灯火完成体验收束。' },
      ],
    },
  },
  paper: {
    modes: {
      night: {
        title: '乌镇水乡里的纸灯文化体验单',
        desc: '跟随乌镇当前地址，优先推荐水岸灯影、蓝印花布与纸灯小铺。',
        bestTime: '18:10',
        tag: '今日可体验',
      },
    },
    routes: {
      night: [
        { time: '16:30', title: '乌篷入场', desc: '沿水路进入，先完成桥、船和街巷观察。' },
        { time: '18:10', title: '水岸灯影', desc: '跟随灯火倒影进入夜游主线。' },
        { time: '19:00', title: '纸灯小铺', desc: '用窗格和水纹完成剪纸或纸灯体验。' },
        { time: '20:00', title: '茶点收束', desc: '用桥头茶点和纪念小物完成沉淀。' },
      ],
    },
  },
  painting: {
    modes: {
      night: {
        title: '古画线索生成的线上体验单',
        desc: '跟随古画解码入口，优先推荐画中线索、现实路线和轻手作。',
        bestTime: '随时',
        tag: '线上可体验',
      },
    },
    routes: {
      night: [
        { time: '00:00', title: '选择古画', desc: '先从清明上河、姑苏繁华或上元灯彩中选择解码对象。' },
        { time: '00:05', title: '点击线索', desc: '从物、艺、人、景、情里挑选体验入口。' },
        { time: '00:10', title: '生成路线', desc: '把画中热点转成现实目的地和可参与动作。' },
        { time: '00:15', title: '保存沉淀', desc: '将路线、技艺和古画线索加入个人文化记录。' },
      ],
    },
  },
};
...
export const GENERATION_LOADING_DURATION_MS = 3000;
...
export function getFilteredContents(state) {
  return getSeedDiscoverContents(state);
}
...
export function getDestinationDisplay(contentId) {
  const selected = destinationOptions.find(item => item.contentId === contentId) || destinationOptions[0];
  return selected.location.split(' · ');
}

function getSeedHomeProfile(contentId) {
  return seedHomeProfiles[contentId] || seedHomeProfiles.festival;
}

export function getSeedHeroRecommendation(contentId) {
  return getSeedHomeProfile(contentId).hero;
}

export function getSeedDiscoverContents(state = {}) {
  const profile = getSeedHomeProfile(state.selectedContentId);
  const cards = profile.discover.map((item, index) => {
    const imageFile = seedDiscoverImages[(profile.imageOffset + index) % seedDiscoverImages.length];
    return {
      id: `${state.selectedContentId || 'festival'}-${index}`,
      ...item,
      image: seedAssetPath(imageFile),
    };
  });
  if (!state.seedFilter || state.seedFilter === '全部') return cards;
  return cards.filter(item => item.type === state.seedFilter);
}
...
export function beginGenerationLoading(state, source = 'detail') {
  state.page = 'loading';
  state.loadingTargetPage = 'result';
  ...
  return state.loadingTargetPage;
}
...
export function getGeneratedPlan(state) {
  const role = state.preference.role || '游客';
  const days = state.preference.days || '两天一夜';
  const vibe = state.preference.vibe || '安静文艺';
  ...
  const selectedSignals = preferenceGroups.map(group => {
    const selected = group.options.find(option => option.label === state.preference[group.key]) || group.options[0];
    return {
      key: group.key,
      title: group.title,
  ...
  return {
    ...
    selectedPreference: { role, days, vibe },
...
export function getExperienceRoute(state) {
  ...
  const destinationRoute = experienceDestinationProfiles[state.selectedContentId]?.routes?.[mode.id];
  if (destinationRoute) return destinationRoute;
  return experienceRoutes[mode.id] || experienceRoutes.night;
}

export function getExperienceDestinationSummary(state) {
  const mode = getExperienceMode(state);
  const destinationMode = experienceDestinationProfiles[state.selectedContentId]?.modes?.[mode.id] || {};
  return { ...mode, ...destinationMode };
}
...
export function saveGuide(state, options = {}) {
  ...
  const guide = {
    ...
    days: state.preference.days,
    vibe: state.preference.vibe,
